...
# ============================================================
# SITZUNGSFORTSCHRITT – NICHT DAUERHAFT GESPEICHERT
# ============================================================
# Die Online-App speichert bewusst keinen Lernfortschritt in Dateien oder
# externen Diensten. Dadurch gibt es keine gemeinsam genutzten Daten zwischen
# verschiedenen Nutzern. Jede Browser-Sitzung startet mit leerem Fortschritt.
...
if "progress" not in st.session_state:
    st.session_state.progress = _default_progress()
...
st.sidebar.caption("LernApp Version 4.2 · Session Edition")
...
st.divider()
st.caption("Industriemeister Metall LernApp · Version 4.2 Session Edition · Kein dauerhafter Lernfortschritt · jede Browser-Sitzung getrennt")
